                                        ...
                                        <tr class="nk-tb-item">
                                            ...
                                            <td class="nk-tb-col">
                                                <a href="#" class="project-title">
                                                    <div class="project-info"><h6 class="title">{{ $assignment->title }}</h6></div>
                                                </a>
                                            </td>
                                            <td class="nk-tb-col tb-col-lg"><span>{{ $assignment->course->name }}</span></td>
                                                        ...
                                                        <div class="drodown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                <ul class="link-list-opt no-bdr">
                                                                    @if(Auth::user()->hasAnyRole(['instructor']))
                                                                        <li>
                                                                            <a href="{{ route('admin.assignments.edit', $assignment) }}"><em class="icon ni ni-edit"></em><span>Edit Assignment</span></a>
                                                                        </li>
                                                                        <li>
                                                                            <a href="javascript:$('#delete_form').submit()"><em class="icon ni ni-delete"></em><span>Delete Assignment</span></a>
                                                                            <form id="delete_form" action="{{ route('admin.assignments.destroy', $assignment) }}" method="post">
                                                                                @csrf
                                                                                @method('delete')
                                                                            </form>
                                                                        </li>
                                                                    @else
                                                                        <li>
                                                                            <a href="{{ route('admin.assignments.show', $assignment) }}"><em class="icon ni ni-edit"></em><span>View Assignment</span></a>
                                                                        </li>
                                                                    @endif
