                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Courses Progress</h3>
                            ...
                            <div class="card-inner p-0">
                                <table class="nk-tb-list nk-tb-ulist">
                                    ...
                                    <tr class="nk-tb-item nk-tb-head">
                                        ...
                                        <th class="nk-tb-col tb-col-lg"><span class="sub-text">Assignments</span></th>
                                        <th class="nk-tb-col tb-col-xxl"><span class="sub-text">Progress</span></th>
                                    ...
                                    @foreach($courses as $course)
                                        <tr class="nk-tb-item">
                                            ...
                                            <td class="nk-tb-col tb-col-lg"><span>Total: {{ count($course->assignments) }}</span></td>
                                            @php
                                                $submitted = $course->assignments->filter(function ($assignment){
                                                    return isset($assignment->student_assignment);
                                                });
                                                $percentage = 0;
                                                if(count($course->assignments) > 0){
                                                   $percentage = (count($submitted)/count($course->assignments))*100;
                                                }
                                            @endphp
                                            <td class="nk-tb-col tb-col-xxl"><span> {{ number_format($percentage, 2).'%'  }}</span></td>
